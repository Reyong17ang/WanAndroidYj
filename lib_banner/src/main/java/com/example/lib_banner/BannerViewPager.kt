...
import IndicatorGravity.CENTER
import IndicatorGravity.END
import IndicatorGravity.START
...
import com.example.lib_banner.options.BannerOptions.Companion.DEFAULT_REVEAL_WIDTH
...
import com.example.lib_banner.base.BaseBannerAdapter.Companion.MAX_VALUE
import com.example.lib_banner.annotation.AIndicatorGravity
import com.example.lib_banner.annotation.AIndicatorSlideMode
import com.example.lib_banner.annotation.AIndicatorStyle
import com.example.lib_banner.annotation.APageStyle
import com.example.lib_banner.annotation.Visibility
...
open class BannerViewPager<T, H : BaseViewHolder<T>> @JvmOverloads constructor(
     ...
     *
     *
     * if the indicator style is [com.example.lib_banner.mode.IndicatorStyle.DASH]
     * or [com.example.lib_banner.mode.IndicatorStyle.ROUND_RECT]
    ...
    /**
     * Set indicator dash width，if indicator style is [com.example.lib_banner.mode.IndicatorStyle.CIRCLE],
     * the indicator circle radius is indicatorWidth/2.
     *
     * @param normalWidth if the indicator style is [com.example.lib_banner.mode.IndicatorStyle.DASH]
     * the params means unchecked dash width
     * if the indicator style is [com.example.lib_banner.mode.IndicatorStyle.ROUND_RECT]  means
     * unchecked round rectangle width
     * if the indicator style is [com.example.lib_banner.mode.IndicatorStyle.CIRCLE] means
     * unchecked circle diameter
     * @param checkWidth if the indicator style is [com.example.lib_banner.mode.IndicatorStyle.DASH]
     * the params means checked dash width
     * if the indicator style is [com.example.lib_banner.mode.IndicatorStyle.ROUND_RECT] the
     ...
     * [com.example.lib_banner.mode.IndicatorGravity.CENTER]
     * [com.example.lib_banner.mode.IndicatorGravity.START]
     * [com.example.lib_banner.mode.IndicatorGravity.END]
     */
    ...
    /**
     * Set Indicator slide mode，default value is [com.example.lib_banner.mode.IndicatorSlideMode.NORMAL]
     *
     * @param slideMode Indicator slide mode
     * @see com.example.lib_banner.mode.IndicatorSlideMode.NORMAL
     *
     * @see com.example.lib_banner.mode.IndicatorSlideMode.SMOOTH
     */
     ...
     * @see com.example.lib_banner.mode.IndicatorStyle.CIRCLE
     *
     * @see com.example.lib_banner.mode.IndicatorStyle.DASH
     *
     * @see com.example.lib_banner.mode.IndicatorStyle.ROUND_RECT
     */
