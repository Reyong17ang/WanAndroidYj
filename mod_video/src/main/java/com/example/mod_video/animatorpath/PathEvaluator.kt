package com.example.mod_video.animatorpath
...
class PathEvaluator : TypeEvaluator<PathPoint> {
    ...
    override fun evaluate(t: Float, startValue: PathPoint, endValue: PathPoint): PathPoint {
        ...
        if (endValue.mOperation == PathPoint.THIRD_CURVE) {
            ...
            x =
                oneMiunsT * oneMiunsT * startValue.mX + 2 * t * oneMiunsT * endValue.mContorl0X + t * t * endValue.mX
            y =
                oneMiunsT * oneMiunsT * startValue.mY + 2 * t * oneMiunsT * endValue.mContorl0Y + t * t * endValue.mY
            //直线
