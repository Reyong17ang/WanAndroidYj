package com.example.mod_video.view
...
import com.example.mod_video.animatorpath.AnimatorPath
import com.example.mod_video.animatorpath.PathEvaluator
import com.example.mod_video.animatorpath.PathPoint
import com.example.mod_video.databinding.LayoutRotateNoteViewBinding
...
class RotateNoteView @JvmOverloads constructor(
    ...
    private fun startPathAnim(
        ...
        val anim4 = ObjectAnimator.ofObject(
            this,
            note_quaver,
            PathEvaluator(),
    ...
    private fun startObjectAnim(
        ...
        val anim_note_quaver_4 =
            ObjectAnimator.ofPropertyValuesHolder(note_quaver, *mPropertyValuesHolders)
